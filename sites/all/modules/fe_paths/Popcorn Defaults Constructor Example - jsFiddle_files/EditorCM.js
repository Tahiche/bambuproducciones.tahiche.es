    ...
    if (this.options.useCodeMirror && !is_disallowed) {
      ...
      this.setEditorEvents({
        ...
        cursorActivity: function(){
          ...
          // Matching identical strings disabled because it's slow
...
MooShellEditor.HTML = new Class({
  ...
  options: {
    ...
    disallowed: {
      ...
      '<script': "For JavaScript use the panel below or the <strong>Resources</strong> panel for external files.",
