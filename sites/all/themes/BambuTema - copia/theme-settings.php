...
drupal_add_js(drupal_get_path('theme', 'BambuTema') .'/js/theme_settings.js'); 
 
function BambuTema_form_system_theme_settings_alter(&$form, &$form_state) {
  global $slide_number;
 ...
 // Default path for image
  ...
  $form['options'] = array(
    ...
    '#weight' => '-10',
    '#attached' => array(
      'css' => array(drupal_get_path('theme', 'BambuTema') . '/css/theme-options.css'),
    ),
  );
  ...
  // Submit Button
  $form['#submit'][] = 'BambuTema_settings_submit';
  $form['#submit'][] = 'BambuTema_background_settings_submit';
  $form['#submit'][] = 'BambuTema_slide_settings_submit';
  
}

function BambuTema_settings_submit($form, &$form_state) {
...
function BambuTema_background_settings_submit($form, &$form_state) {
...
// for slider images
function BambuTema_slide_settings_submit($form, &$form_state) {
  global $slide_number;
  $counter = '1';
